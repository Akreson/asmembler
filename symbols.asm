...
TOKEN_NAME_JMP       equ 0x04
TOKEN_NAME_DATA      equ 0x08
...
INS_CMOVCC_TYPE_MASK equ 0x20000000

;STR_REPS
INS_REP   equ 0x81000000
INS_MOV   equ 0x01000001
INS_MOVS  equ 0x01000002
INS_MOVSB equ 0x01000003
INS_MOVSW equ 0x01000004
INS_MOVSD equ 0x01000005
INS_MOVZX equ 0x01000006
INS_MOVSX equ 0x01000007
INS_LEA   equ 0x01000008
INS_RET   equ 0x01000009
INS_POP   equ 0x0100000A
INS_PUSH  equ 0x0100000B
INS_INC   equ 0x0100000C
INS_DEC   equ 0x0100000D
INS_AND   equ 0x0100000E
INS_OR    equ 0x0100000F
INS_XOR   equ 0x01000010
INS_ADD   equ 0x01000011
INS_SHL   equ 0x01000012
INS_SAL   equ 0x01000013
INS_SHR   equ 0x01000014
...
INS_BSR   equ 0x0100001C
INS_BSF   equ 0x0100001D
INS_TZCNT equ 0x0100001E
INS_LZCNT equ 0x0100001F
INS_CMP   equ 0x01000020
INS_CALL  equ 0x41000021
INS_JMP   equ 0x41000022
; NOTE: order of jcc ins. must not be changed
INS_JO    equ 0x41800023
INS_JNO   equ 0x41800024
INS_JB    equ 0x41800025
INS_JAE   equ 0x41800026
INS_JE    equ 0x41800027
INS_JNE   equ 0x41800028
INS_JBE   equ 0x41800029
INS_JA    equ 0x4180002A
INS_JS    equ 0x4180002B
INS_JNS   equ 0x4180002C
INS_JP    equ 0x4180002D
INS_JNP   equ 0x4180002E
INS_JL    equ 0x4180002F
INS_JGE   equ 0x41800030
...
INS_CMOVO   equ 0x21000036
INS_CMOVNO  equ 0x21000037
INS_CMOVB   equ 0x21000038
INS_CMOVAE  equ 0x21000039
INS_CMOVE   equ 0x2100003A
INS_CMOVNE  equ 0x2100003B
INS_CMOVBE  equ 0x2100003C
INS_CMOVA   equ 0x2100003D
INS_CMOVS   equ 0x2100003E
INS_CMOVNS  equ 0x2100003F
INS_CMOVP   equ 0x21000040
INS_CMOVNP  equ 0x21000041
INS_CMOVL   equ 0x21000042
INS_CMOVGE  equ 0x21000043
INS_CMOVLE  equ 0x21000044
INS_CMOVG   equ 0x21000045
...
SEC_SEG_TYPE_MOD_MASK equ 0x038000
SEC_SEG_VAL_MOD_MASK equ 0xFF
ADDR_QUL_TYPE_MASK equ 0x034000
DATA_QUL_TYPE_MASK equ 0x032000
...
KW_RDBL  equ 0x038004
KW_WRTB  equ 0x038002
KW_EXTB  equ 0x038001
KW_INCL  equ 0x03000A
KW_MACR  equ 0x03000B
KW_ENTRY equ 0x03000C
KW_BYTE  equ 0x03400D
KW_WORD  equ 0x03400E
KW_DWORD equ 0x03400F
KW_QWORD equ 0x034010
