...
;INS_MOVS  equ 0x10000002
INS_MOVSB equ 0x11000003
INS_MOVSW equ 0x11000004
INS_MOVSD equ 0x11000005
INS_MOVZX equ 0x11000006
INS_MOVSX equ 0x11000007
INS_LEA   equ 0x10000008
INS_RET   equ 0x11000009
INS_POP   equ 0x1000000A
INS_PUSH  equ 0x1000000B
INS_INC   equ 0x1000000C
INS_DEC   equ 0x1000000D
INS_AND   equ 0x1000000E
INS_OR    equ 0x1000000F
INS_XOR   equ 0x10000010
INS_ADD   equ 0x10000011
INS_SHL   equ 0x10000012
INS_SAL   equ 0x10000013
INS_SHR   equ 0x10000014
INS_SAR   equ 0x10000015
INS_SUB   equ 0x10000016
...
INS_NEG   equ 0x10000034
INS_NOT   equ 0x10000035
